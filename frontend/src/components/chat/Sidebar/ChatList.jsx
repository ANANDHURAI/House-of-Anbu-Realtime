        ...
        <div className="divide-y divide-slate-100">
          {chats.map((chat, index) => (
            <div
              ...
              className="group relative p-4 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 cursor-pointer transition-all duration-300 flex items-center gap-3"
              style={{
            ...
            >
              ...
              {/* Profile Image */}
              <div 
                className="relative flex-shrink-0 cursor-pointer transform group-hover:scale-110 transition-transform duration-300 z-10"
              ...
              {/* Chevron indicator */}
              <svg 
                className="w-5 h-5 text-slate-300 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 z-10" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
