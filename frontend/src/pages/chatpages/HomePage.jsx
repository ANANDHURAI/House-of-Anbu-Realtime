...
return (
  <div className="flex h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-teal-50/30 overflow-hidden">
    ...
    <div
      ...
      } md:flex flex-col w-full md:w-96 bg-white/80 backdrop-blur-xl border-r border-slate-200/50 shadow-2xl relative z-10`}
    >
      
      <div className="relative bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 text-white p-5 shadow-lg overflow-hidden">
