...
function HomePage() {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`${activeChat ? 'hidden md:flex' : 'flex'} md:flex flex-col w-full md:w-96 bg-white border-r shadow-lg`}>
        {/* Sidebar Header */}
        ...
        {activeChat ? (
          ...
          <div className="hidden md:flex flex-col items-center justify-center h-full bg-gradient-to-br from-green-50 to-emerald-50">
            <div className="text-center p-8 max-w-md">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-3">Welcome to Chat App</h2>
